...
const plans: PricingPlan[] = [
  {
    title: "Small Pack",
    price: "$9.99",
    description: "Perfect for grassroots organizations and community initiatives",
  ...
  },
  {
    title: "Medium Pack",
    price: "$24.99",
    description: "Best value for established community organizations",
  ...
  },
  {
    title: "Large Pack",
    price: "$69.99",
    description: "Ideal for larger nonprofits and community coalitions",
    ...
    <div className="mx-auto flex flex-col space-y-8 px-4 py-12">
      <div className="relative flex items-center justify-center gap-4">
        ...
        <div className="space-y-2 text-center">
          ...
          <p className="text-muted-foreground">
            Purchase credits to generate more community story highlights. The more credits
      ...
      <div className="bg-muted/50 rounded-lg p-6">
        ...
        <ul className="text-muted-foreground list-disc space-y-2 pl-5 text-sm">
          <li>1 credit = 1 minute of community story processing</li>
          <li>
            The program will create around 1 highlight per 5 minutes of content
          </li>
          <li>Credits never expire and can be used anytime</li>
          <li>Longer community conversations require more credits based on duration</li>
