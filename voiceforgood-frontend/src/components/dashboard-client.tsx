    ...
    <div className="mx-auto flex max-w-5xl flex-col space-y-6 px-4 py-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Upload your community stories and get AI-generated highlights instantly
          </p>
        </div>
      ...
      <Tabs defaultValue="upload">
        ...
        <TabsContent value="upload">
          <Card>
            <CardHeader>
              <CardTitle>Upload Community Story</CardTitle>
              <CardDescription>
                Upload your interview, testimonial, or community conversation to generate impactful highlights
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Dropzone
                  ...
                  <>
                    <div className="flex flex-col items-center justify-center space-y-4 rounded-lg p-10 text-center">
                      ...
                      <p className="text-muted-foreground text-sm">
                        or click to browse (MP4 up to 500MB) - Perfect for community interviews, testimonials, and impact stories
                      </p>
                      <Button
              ...
              <div className="mt-2 flex items-start justify-between">
                ...
                >
                  {uploading ? (
                    ...
                    "Upload and Generate Highlights"
                  )}
                </Button>
              </div>
        ...
        <TabsContent value="my-clips">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                View and manage your generated community story highlights here. Processing may take a
                few minutes.
              </CardDescription>
            </CardHeader>
            <CardContent>
