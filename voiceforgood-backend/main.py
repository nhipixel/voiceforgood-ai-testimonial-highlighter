...
class VoiceForGood:
    ...
    def identify_moments(self, transcript: dict):
        ...
        This is a testimonial video transcript consisting of word, along with each words's start and end time. I am looking to create clips between a minimum of 30 and maximum of 60 seconds long. The clip should never exceed 60 seconds.
...
def main():
    ...
    voiceforgood = VoiceForGood()

    url = voiceforgood.process_video.web_url
